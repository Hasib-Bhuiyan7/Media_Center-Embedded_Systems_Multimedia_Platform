...
* Dynamically renders images using `GLCD_Bitmap()`
...
A custom pixel-based rectangle rendering function (`DrawRectFilled`) was implemented using `GLCD_PutPixel()` to create animated game objects directly at the pixel level.
